...
typedef void(*read_callback_function)(void* dest, u64 addr, u64 offset, size_t len, void* private_data);
typedef void(*write_callback_function)(void* src, u64 addr, u64 offset, size_t len, void* private_data);

typedef struct address_bus_entry_impl {
    u64 address;
    size_t length;
    read_callback_function read_callback_func;
    write_callback_function write_callback_func;
    void* private_data;
} address_bus_entry;
